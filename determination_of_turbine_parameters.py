...
class RegularTurbin:
    ...
    def calc_sopl_lop(self, b_1, alpha_1_e, t_1opt):
        ...
        self.zit_prof = - 3.7708 * ((self.mu_1_pred)**3) + 14.189 * ((self.mu_1_pred)**2) - 13.478 * (self.mu_1_pred) + 5.6125
        self.zit_konc_l_d = 2 * self.b_1_l_1 + 2
        self.alpha_yst = np.rad2deg(self.alpha_1_e) - 16 * (self.t_1opt - 0.75) + 23.1 
        self.zit_c = self.zit_prof + self.zit_konc_l_d
        self.fi = (1 - (self.zit_c)/100) ** 0.5
    ...
    def calc_for_find_koef_rab_lop(self, pere):
        ...
        return self.m_2_pred, self.delt_H_c, self.H_oc, self.zit_c
    ...
    def calc_rab_lop(self, b_2, t_opt_2):
        ...
        self.bet_yst = np.rad2deg(self.betta_2e) - 19.3 * ( self.t_opt_2 - 0.6) + 60
        self.zit_prof = 7.4173 * ((self.m_2_pred)**3) -10.511 * ((self.m_2_pred)**2) + 1.0066 * (self.m_2_pred) + 6.4416
        self.zit_konc_l_d = 4.8786 * (self.b_2_l_2) + 4.9714
        self.zit_r = self.zit_prof + self.zit_konc_l_d
        self.ksi = (1 - self.zit_r/100) ** 0.5 
    ...
    def tabl(self):
        ...
        return self.tabl_one, self.tabl_two, self.tabl_three

    def points(self):

        return self.tochka_1_t, self.tochka_1, self.tochka_2_t, self.tochka_2, self.tochka_o
