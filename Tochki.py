...
class Parametry:
    ...
    def __init__(self, N, P0, t0, P_pp, t_pp, t_pw, Pk, internal_efficiency, mechanical_efficiency, generator_efficiency):
        ...
        self.point_feed_water = gas(P=P_fw * unit, T=T_pw) # Нахождение точки питательной воды
